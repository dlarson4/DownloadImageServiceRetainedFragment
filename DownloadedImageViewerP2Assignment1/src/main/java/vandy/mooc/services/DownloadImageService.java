...
public class DownloadImageService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
        String directoryPath = intent.getExtras().getString(DIRECTORY_PATHNAME);

        // Download the requested image.
        // @@ TODO -- you fill in here.
        Uri pathToImageFile = Utils.downloadImage(this, uri, directoryPath);

        // Extract the Messenger stored as an extra in the
        // intent under the key MESSENGER.
        // @@ TODO -- you fill in here.
        Messenger messenger = intent.getExtras().getParcelable(MESSENGER);

        // Send the path to the image file back to the
        // MainActivity via the messenger.
        // @@ TODO -- you fill in here.
        sendPath(messenger, pathToImageFile, uri);
    }
    ...
    private void sendPath(Messenger messenger, Uri pathToImageFile, Uri url) {
        ...
        try {
            ...
            Log.e(TAG, "Error sending to Handler", e);
        }
    }
